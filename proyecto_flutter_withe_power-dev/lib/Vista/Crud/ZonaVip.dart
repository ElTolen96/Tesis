...
class ZonaVip extends StatefulWidget {
  static final String routeName = Mensajes.RUTA_ZONAVIP;

  ZonaVip({Key? key});

  @override
  _ZonaVipState createState() => _ZonaVipState();
}

class _ZonaVipState extends State<ZonaVip> {
  ...
  getListarZona(){
    isLoading = true;
    _apiServices.getZona("1").then((value) {
      zonaModel = value;
      isLoading = false;
      setState(() {
  ...
  void updateImageList(BuildContext context) async {
    imageList.add(const AssetImage('assets/images/zonavip.jpeg'));
    //* To precache images so that when required they are loaded faster.
    await precacheImage(const AssetImage('assets/images/zonavip.jpeg'), context);
    setState(() {
      imagePrecached = true;
    });
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField2(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return 'Por favor selecciona el eventi';
                          }
                        },
                        onChanged: (value) {
