...
class HomeImage2 extends StatefulWidget {
  static final String routeName = Mensajes.RUTA_HOMEIMAGEN2USUARIO;

  const HomeImage2({Key? key});

  @override
  _HomeImage2State createState() => _HomeImage2State();
}

class _HomeImage2State extends State<HomeImage2> {
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navegacion.ir_HOMEIMAGEN3USUARIO(context);
                    },
                    ...
                    style: ButtonStyle(
                      ...
                      backgroundColor: MaterialStateProperty.all(
                          const Color(0XFF999999)), // <-- Button color
                      overlayColor:
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 24,),
                    Text(
                      "Asiste a tus eventos favoritos y lleva a tus amigos.",
                      maxLines: 3,
                    ...
                    Text(
                      "No te pierdas los eventos más esperados en White Power.",
                      maxLines: 3,
                      overflow: TextOverflow.ellipsis,
                      style: GoogleFonts.openSans(
