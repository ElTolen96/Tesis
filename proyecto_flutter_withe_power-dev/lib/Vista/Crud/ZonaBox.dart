...
class ZonaBox extends StatefulWidget {
  static final String routeName = Mensajes.RUTA_ZONABOX;

  ZonaBox({Key? key});

  @override
  _ZonaBoxState createState() => _ZonaBoxState();
}

class _ZonaBoxState extends State<ZonaBox> {
  ...
  getListarZona() {
    isLoading = true;
    _apiServices.getZona("2").then((value) {
      zonaModel = value;
      isLoading = false;
      setState(() {
  ...
  void updateImageList(BuildContext context) async {
    imageList.add(const AssetImage('assets/images/zonabox1.jpeg'));
    //* To precache images so that when required they are loaded faster.
    await precacheImage(
        const AssetImage('assets/images/zonabox1.jpeg'), context);

    imageList.add(const AssetImage('assets/images/zonabox2.jpeg'));
    //* To precache images so that when required they are loaded faster.
    await precacheImage(
        const AssetImage('assets/images/zonabox2.jpeg'), context);
                  ...
                  actions: <Widget>[
                    Padding(
                      ...
                      child: RawMaterialButton(
                        constraints:
                            BoxConstraints(minWidth: 45.0, minHeight: 15.0),
                        onPressed: () {
