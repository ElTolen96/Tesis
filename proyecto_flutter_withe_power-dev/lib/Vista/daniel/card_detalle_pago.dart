  ...
  Widget build(BuildContext context) {
    final List<Widget> children = [
      ...
      Expanded(child: Column( crossAxisAlignment: CrossAxisAlignment.start,
        ...
        mainAxisAlignment: MainAxisAlignment.start,children: [secondChild],) ),
    ];
